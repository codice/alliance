...
package org.codice.alliance.branding.impl;
...
public class AllianceBrandingPluginTest {
    ...
    public void testInitException() {
        AllianceBrandingPlugin allianceBrandingPlugin = new AllianceBrandingPlugin(invalidPropertiesFile);
        allianceBrandingPlugin.init();
    ...
    public void testProductImage() throws IOException {
        allianceBrandingPlugin.init();
        assertThat(allianceBrandingPlugin.getBase64ProductImage(),
                is(equalTo(Base64.getEncoder()
                        .encodeToString(IOUtils.toByteArray(AllianceBrandingPluginTest.class.getResourceAsStream(
                                productImage))))));
    }
    ...
    public void testVendorImage() throws IOException {
        allianceBrandingPlugin.init();
        assertThat(allianceBrandingPlugin.getBase64VendorImage(),
                is(equalTo(Base64.getEncoder()
                        .encodeToString(IOUtils.toByteArray(AllianceBrandingPluginTest.class.getResourceAsStream(
                                vendorImage))))));
    }
    ...
    public void testFavIcon() throws IOException {
        allianceBrandingPlugin.init();
        assertThat(allianceBrandingPlugin.getBase64FavIcon(),
                is(equalTo(Base64.getEncoder()
                        .encodeToString(IOUtils.toByteArray(AllianceBrandingPluginTest.class.getResourceAsStream(
                                favIcon))))));
    }
