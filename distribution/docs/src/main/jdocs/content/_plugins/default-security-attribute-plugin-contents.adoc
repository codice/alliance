...
:summary: Maps user attributes to metacard attributes for system user.
...
These metacards will be flagged for administrator review with default marking.
...
include::{adoc-include-cal}/_tables/org.codice.alliance.catalog.plugin.defaultsecurity.DefaultSecurityAttributeValuesPlugin-table-contents.adoc[]
