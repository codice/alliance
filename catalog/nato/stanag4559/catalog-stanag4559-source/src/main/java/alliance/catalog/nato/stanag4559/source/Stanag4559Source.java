...
import alliance.catalog.nato.stanag4559.common.GIAS.LibraryDescription;
...
import alliance.catalog.nato.stanag4559.common.GIAS.Polarity;
...
public class Stanag4559Source extends MaskableImpl
    ...
    public static final String ACCESS_CRITERIA_USERNAME = "accessCriteriaUsername";

    public static final String ACCESS_CRITERIA_PASSWORD = "accessCriteriaPassword";
    ...
    private String accessCriteriaUsername;

    private String accessCriteriaPassword;
    ...
    private void initCorbaClient() {
        accessCriteria = new AccessCriteria(accessCriteriaUsername, accessCriteriaPassword, key);
    ...
    public void refresh(Map<String, Object> configuration) {
        ...
        String accessCriteriaUsername = (String) configuration.get(ACCESS_CRITERIA_USERNAME);
        if (StringUtils.isNotBlank(accessCriteriaUsername)
                && !accessCriteriaUsername.equals(this.accessCriteriaUsername)) {
            setAccessCriteriaUsername(accessCriteriaUsername);
        }
        String accessCriteriaPassword = (String) configuration.get(ACCESS_CRITERIA_PASSWORD);
        if (StringUtils.isNotBlank(accessCriteriaPassword)
                && !accessCriteriaPassword.equals(this.accessCriteriaPassword)) {
            setAccessCriteriaPassword(accessCriteriaPassword);
        }
    ...
    public SourceResponse query(QueryRequest queryRequest) throws UnsupportedQueryException {
        alliance.catalog.nato.stanag4559.common.GIAS.Query query = createQuery(queryRequest.getQuery());
     ...
     */
    private int getHitCount(alliance.catalog.nato.stanag4559.common.GIAS.Query query,
    ...
    private SourceResponse submitQuery(QueryRequest queryRequest,
            alliance.catalog.nato.stanag4559.common.GIAS.Query query, String[] resultAttributes,
    ...
    public void setAccessCriteriaUsername(String accessCriteriaUsername) {
        this.accessCriteriaUsername = accessCriteriaUsername;
    }

    public void setAccessCriteriaPassword(String accessCriteriaPassword) {
        this.accessCriteriaPassword = accessCriteriaPassword;
    }
    ...
    public String getAccessCriteriaUsername() {
        return accessCriteriaUsername;
    }

    public String getAccessCriteriaPassword() {
        return accessCriteriaPassword;
    }
