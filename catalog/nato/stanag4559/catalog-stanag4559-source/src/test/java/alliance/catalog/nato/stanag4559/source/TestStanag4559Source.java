...
import alliance.catalog.nato.stanag4559.common.UCO.State;
...
public class TestStanag4559Source {
    ...
    public void testInitialContentList() {
        ...
        assertThat(source.getContentTypes(), is(Stanag4559Constants.CONTENT_TYPES));
    }
    ...
    public void testQueryUnsupportedSorting() throws Exception {
        QueryImpl propertyIsLikeQuery =
                new QueryImpl(builder.attribute(Metacard.CONTENT_TYPE)
                        .is()
                        .equalTo()
                        .text(GMTI));
    ...
    public void testRefresh() throws Exception {
        ...
        configuration.put(Stanag4559Source.CXF_USERNAME, GMTI);
        configuration.put(Stanag4559Source.CXF_PASSWORD, GMTI);
        configuration.put(Stanag4559Source.ACCESS_CRITERIA_USERNAME, GMTI);
        configuration.put(Stanag4559Source.ACCESS_CRITERIA_PASSWORD, GMTI);
    ...
    private Stanag4559Source buildSource() throws Exception {
        ...
        source.setCxfUsername(Stanag4559Source.CXF_USERNAME);
        source.setCxfPassword(Stanag4559Source.CXF_PASSWORD);
        source.setAccessCriteriaUsername(Stanag4559Source.ACCESS_CRITERIA_USERNAME);
        source.setAccessCriteriaPassword(Stanag4559Source.ACCESS_CRITERIA_PASSWORD);
    ...
    private void assertConfiguration(Stanag4559Source source) {
        ...
        assertThat(source.getCxfUsername(), is(Stanag4559Source.CXF_USERNAME));
        assertThat(source.getCxfPassword(), is(Stanag4559Source.CXF_PASSWORD));
        assertThat(source.getAccessCriteriaUsername(),
                is(Stanag4559Source.ACCESS_CRITERIA_USERNAME));
        assertThat(source.getAccessCriteriaPassword(),
                is(Stanag4559Source.ACCESS_CRITERIA_PASSWORD));
    ...
    private void assertChangedConfiguration(Stanag4559Source source, String newConstantString, int newConstantInteger) {
        ...
        assertThat(source.getAccessCriteriaUsername(), is(newConstantString));
        assertThat(source.getAccessCriteriaPassword(), is(newConstantString));
        assertThat(source.getKey(), is(newConstantString));
