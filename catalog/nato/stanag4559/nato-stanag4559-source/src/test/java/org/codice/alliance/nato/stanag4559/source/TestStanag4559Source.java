...
import org.codice.alliance.nato.stanag4559.common.UCO.State;
...
public class TestStanag4559Source {
    ...
    public void testQuerySupportedAscendingSorting() throws Exception {
        ...
        assertThat(argumentCaptor.getValue()[0].attribute_name,
                is(Stanag4559Constants.DATE_TIME_MODIFIED));
    ...
    private HashMap<String, List<String>> generateMockSortableAttributes() {
        ...
        sortableAttributes.put(Stanag4559Constants.NSIL_ALL_VIEW,
                Arrays.asList(Stanag4559Constants.DATE_TIME_DECLARED,
                        Stanag4559Constants.DATE_TIME_MODIFIED));
    ...
    private void assertChangedConfiguration(Stanag4559Source source, String newConstantString,
