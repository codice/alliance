...
import org.codice.alliance.nato.stanag4559.common.GIAS.LibraryDescription;
...
import org.codice.alliance.nato.stanag4559.common.GIAS.Polarity;
...
import org.codice.alliance.nato.stanag4559.common.GIAS.View;
import org.codice.alliance.nato.stanag4559.common.Stanag4559;
...
import org.codice.alliance.nato.stanag4559.common.UCO.InvalidInputParameter;
import org.codice.alliance.nato.stanag4559.common.UCO.NameValue;
import org.codice.alliance.nato.stanag4559.common.UCO.ProcessingFault;
import org.codice.alliance.nato.stanag4559.common.UCO.SystemFault;
import org.codice.alliance.nato.stanag4559.transformer.DAGConverter;
...
public class Stanag4559Source extends MaskableImpl
    ...
    private AccessCriteria accessCriteria =
            new AccessCriteria(Stanag4559FilterDelegate.EMPTY_STRING,
    ...
    public SourceResponse query(QueryRequest queryRequest) throws UnsupportedQueryException {
        org.codice.alliance.nato.stanag4559.common.GIAS.Query query =
     ...
     */
    private org.codice.alliance.nato.stanag4559.common.GIAS.Query createQuery(Query query)
            throws UnsupportedQueryException {
        String filter = createFilter(query);
        LOGGER.debug("{} : BQS Query : {}", getId(), filter);
        return new org.codice.alliance.nato.stanag4559.common.GIAS.Query(Stanag4559Constants.NSIL_ALL_VIEW,
                filter);
    }
     ...
     */
    private int getHitCount(org.codice.alliance.nato.stanag4559.common.GIAS.Query query,
    ...
    private SourceResponse submitQuery(QueryRequest queryRequest,
            org.codice.alliance.nato.stanag4559.common.GIAS.Query query, String[] resultAttributes,
    ...
    private SortAttribute[] getSortAttributes(SortBy sortBy) {
        ...
        if (sortAttribute.equals(Metacard.MODIFIED)
                && isAttributeSupported(Stanag4559Constants.DATE_TIME_MODIFIED)) {
            SortAttribute[] sortAttributeArray =
                    {new SortAttribute(Stanag4559Constants.DATE_TIME_MODIFIED, sortPolarity)};
            return sortAttributeArray;
        } else if (sortAttribute.equals(Metacard.CREATED) && isAttributeSupported(
                Stanag4559Constants.DATE_TIME_DECLARED)) {
            SortAttribute[] sortAttributeArray =
                    {new SortAttribute(Stanag4559Constants.DATE_TIME_DECLARED, sortPolarity)};
            return sortAttributeArray;
        } else {
            return new SortAttribute[0];
        }
