...
import org.codice.alliance.nato.stanag4559.common.Stanag4559Classification;
import org.codice.alliance.nato.stanag4559.common.Stanag4559ClassificationComparator;
...
import org.codice.alliance.nato.stanag4559.common.Stanag4559Security;
...
public class DAGConverter {
    ...
    private static MetacardImpl parseGraph(DirectedAcyclicGraph<Node, Edge> graph) {
        ...
        if (!associatedCards.isEmpty()) {
            ...
            for (Serializable association : associatedCards) {
                if (firstAssoc) {
                    attribute = new AttributeImpl(Stanag4559MetacardType.ASSOCIATIONS, association);
    ...
    public static void addNsilApprovalAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.APPROVED_BY:
            metacard.setAttribute(new AttributeImpl(Stanag4559MetacardType.APPROVAL_BY, getString(
                    node.value)));
            break;
    ...
    public static void addNsilCommonAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.TARGET_NUMBER:
            metacard.setAttribute(new AttributeImpl(Stanag4559MetacardType.TARGET_NUMBER, getString(
                    node.value)));
            break;
    ...
    public static void addNsilCoverageAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.SPATIAL_COUNTRY_CODE:
            metacard.setAttribute(new AttributeImpl(Stanag4559MetacardType.COUNTRY_CODE, getString(
                    node.value)));
            break;
    ...
    public static void addNsilFileAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.FORMAT:
            metacard.setAttribute(new AttributeImpl(Stanag4559MetacardType.FILE_FORMAT, getString(
                    node.value)));
            break;
    ...
    public static void addNsilImageryAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.NIIRS:
            metacard.setAttribute(new AttributeImpl(Stanag4559ImageryMetacardType.NIIRS, getShort(
                    node.value)));
            break;
        ...
        case Stanag4559Constants.NUMBER_OF_ROWS:
            metacard.setAttribute(new AttributeImpl(Stanag4559ImageryMetacardType.NUM_ROWS, getLong(
                    node.value)));
            break;
        case Stanag4559Constants.NUMBER_OF_COLS:
            metacard.setAttribute(new AttributeImpl(Stanag4559ImageryMetacardType.NUM_COLS, getLong(
                    node.value)));
            break;
        case Stanag4559Constants.TITLE:
            metacard.setTitle(getString(node.value));
    ...
    public static void addNsilRfiAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.FOR_ACTION:
            metacard.setAttribute(new AttributeImpl(Stanag4559RfiMetacardType.FOR_ACTION, getString(
                    node.value)));
            break;
    ...
    public static void addNsilTaskAttribute(MetacardImpl metacard, Node node) {
        ...
        switch (node.attribute_name) {
        case Stanag4559Constants.COMMENTS:
            metacard.setAttribute(new AttributeImpl(Stanag4559TaskMetacardType.COMMENTS, getString(
                    node.value)));
            break;
        case Stanag4559Constants.STATUS:
    ...
    public static void addNsilTdlAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.ACTIVITY:
            metacard.setAttribute(new AttributeImpl(Stanag4559TdlMetacardType.ACTIVITY, getShort(
                    node.value)));
            break;
        ...
        case Stanag4559Constants.PLATFORM:
            metacard.setAttribute(new AttributeImpl(Stanag4559TdlMetacardType.PLATFORM, getShort(
                    node.value)));
            break;
        case Stanag4559Constants.TRACK_NUM:
            metacard.setAttribute(new AttributeImpl(Stanag4559TdlMetacardType.TRACK_NUM, getString(
                    node.value)));
            break;
        default:
            break;
    ...
    public static void addNsilVideoAttribute(MetacardImpl metacard, Node node) {
        ...
        case Stanag4559Constants.FRAME_RATE:
            ...
            break;
        case Stanag4559Constants.NUMBER_OF_ROWS:
            metacard.setAttribute(new AttributeImpl(Stanag4559VideoMetacardType.NUM_ROWS, getLong(
                    node.value)));
            break;
        case Stanag4559Constants.NUMBER_OF_COLS:
            metacard.setAttribute(new AttributeImpl(Stanag4559VideoMetacardType.NUM_COLS, getLong(
                    node.value)));
            break;
    ...
    public static void setTopLevelMetacardAttributes(MetacardImpl metacard) {
        ...
        if (fileProductURLAttr != null) {
            ...
            if (fileFormatAttr != null) {
                metacard.setContentTypeName(fileFormatAttr.getValue()
                        .toString());
            }

            Attribute fileFormatVerAttr =
                    metacard.getAttribute(Stanag4559MetacardType.FILE_FORMAT_VER);
            ...
            Attribute streamURLAttr =
                    metacard.getAttribute(Stanag4559MetacardType.STREAM_SOURCE_URL);
            if (streamURLAttr != null) {
                metacard.setResourceURI(convertURI(streamURLAttr.getValue()
                        .toString()));

                if (metacard.getTitle() == null) {
                    //Use a static stream title
                    metacard.setTitle(STREAM_TITLE);
                }

                Attribute streamFormatAttr =
                        metacard.getAttribute(Stanag4559MetacardType.STREAM_STANDARD);
                if (streamFormatAttr != null) {
                    metacard.setContentTypeName(streamFormatAttr.getValue()
                            .toString());
                }

                Attribute streamFormatVerAttr =
                        metacard.getAttribute(Stanag4559MetacardType.STREAM_STANDARD_VER);
        ...
        if (Stanag4559MessageMetacardType.class.getCanonicalName()
                .equals(metacard.getMetacardType()
                        .getClass()
                        .getCanonicalName())) {
            Attribute subjAttr =
                    metacard.getAttribute(Stanag4559MessageMetacardType.MESSAGE_SUBJECT);
            if (subjAttr != null) {
            ...
            if (typeAttr != null) {
                metacard.setContentTypeName(typeAttr.getValue()
                        .toString());

                //Unset the version when we have a message
                metacard.setContentTypeVersion(null);
            }
        } else if (Stanag4559VideoMetacardType.class.getCanonicalName()
                .equals(metacard.getMetacardType()
                        .getClass()
                        .getCanonicalName())) {
            ...
            if (encodingSchemeAttr != null) {
                metacard.setContentTypeName(encodingSchemeAttr.getValue()
                        .toString());
    ...
    public static Date convertDate(Any any) {
        ...
        org.codice.alliance.nato.stanag4559.common.UCO.Date ucoDate = absTime.aDate;
        org.codice.alliance.nato.stanag4559.common.UCO.Time ucoTime = absTime.aTime;
    ...
    public static String mergeClassificationString(String classification1, String classification2) {
        ...
        Stanag4559ClassificationComparator classificationComparator =
                new Stanag4559ClassificationComparator();
