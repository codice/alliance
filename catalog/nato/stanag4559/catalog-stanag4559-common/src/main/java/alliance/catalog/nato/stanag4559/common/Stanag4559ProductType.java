...
public enum Stanag4559ProductType {
    ...
    private static final  Map<String, Stanag4559ProductType> specNameMap = new HashMap<>();
    static {
        for (Stanag4559ProductType productType:Stanag4559ProductType.values()) {
    ...
    private Stanag4559ProductType(String specName) {
        this.specName = specName;
    }

    public static Stanag4559ProductType fromSpecName(String specName) {
