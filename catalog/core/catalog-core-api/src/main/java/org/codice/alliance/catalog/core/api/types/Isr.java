...
public interface Isr {
    ...
    /**
     * Attribute name for accessing the activity name for this Metacard.
     */
    String ACTIVITY_NAME = "isr.activity-name";

    /**
     * Attribute name for accessing the activity type for this Metacard.
     */
    String ACTIVITY_TYPE = "isr.activity-type";
    ...
    /**
     * Attribute name for accessing the copyright for this Metacard.
     */
    String COPYRIGHT = "isr.copyright";

    /**
     * Attribute name for accessing the Data Type for this Metacard.
     */
    String DATA_TYPE = "isr.data-type";
    ...
    /**
     * Attribute name for accessing the information cut off date for this Metacard.
     */
    String INFO_CUT_OFF = "isr.info-cut-off";

    /**
     * Attribute name for accessing the intellectual property of for this Metacard.
     */
    String INTELLECTUAL_PROPERTY = "isr.intellectual-property";
    ...
    /**
     * Attribute name for accessing the privacy act information (US only) for this Metacard.
     */
    String PRIVACY_ACT = "isr.privacy-act";
    ...
    /**
     * Attribute name for accessing the the repository for this Metacard.
     */
    String REPOSITORY = "isr.repository";
